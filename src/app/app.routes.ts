...
import { DeliverysComponent } from './pages/private/deliveries/deliveries.component';
...
export const routes: Routes = [
    ...
    { path: 'dashboard/deliveries', component: DeliverysComponent},
    ...
    { path: 'dashboard/products/edit', component: ProductEditComponent},
